...
// HOCs
import { withBalanceForCalendar, withPinCode } from '@/lib/hocs';
...
const CardBalanceMemorized = memo(
  withBalanceForCalendar(withPinCode(CardBalanceForCalendar)),
);
